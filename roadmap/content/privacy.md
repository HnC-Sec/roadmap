...
- **Server membership and roles:** a member's roles and top-role position, used only to decide whether that member is exempt from scanning **before** their message is classified. Self-assignable cosmetic roles do not grant exemption.
...
- Changed your mind? Use **`/skidoptin`** at any time to reverse an opt-out. It removes the exempt role and resumes normal scanning, just like every non-exempt member. (Established members above **@Active** stay exempt regardless.)
